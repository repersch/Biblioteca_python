    ...
    while opção != "6":
        ...
        if opção == "5":
            ...
            if pessoa not in usuários:
                ...
                if resposta == "S":
                    print(f"Usuário --{usuários[pessoa][0]}-- excluído com sucesso.")
                    del usuários[pessoa]
    ...
    while opção != "6":
        ...
        if opção == "3":
            ...
            if isbn in livros.keys():
                ...
                livros[isbn].append(str(input("Insira o Gênero do livro: ")))
                list_autores= [ ]
                escolha = "S"
                while escolha in "S":
                ...
                livros[isbn].append(input("Número de páginas: "))
        ...
        if opção == "5":
            isbn = input("Digite o ISBN do livro que deseja deletar da lista: ")
...
def sub_empréstimos(usuários, livros):
    ...
    if opção == "3":
        ...
        empréstimos[empréstimo].append(input("Data de devolução[xx/xx/xxxx]: "))
        empréstimos[empréstimo].append(float(input("Valor diário da Multa por Atraso: R$")))
        print(empréstimos)
        ...
        if data > data_inicial and data <= data_final:
            ...
            for empréstimo in empréstimos.keys():
                if lista_empréstimo == empréstimo:
                    print(f"Data de devolução: {empréstimos[lista_empréstimo][0]}")
                    print(f"Valor diário da multa por atraso: R${empréstimos[lista_empréstimo][1]:.2f}")
...
#programa principal
usuários = {'44935673842': ['Leticia Pereira','Maria Augusta','37','13567453',['leticia@mail.com','lpereira@mail.com'],['16776453897','1655436276'],'12/10/1990','Gerente'],
            '65574833907': ['Leonardo Mendes','São Joaquim','1254','13564378',['leo_mendes@mail.com','leoleoleo@mail.com','mendesleo@mail.com'],['1633333332'],'13/08/1990','Professor']}       
livros = {'1234567890567': ['Harry Potter', 'Ficção', ['J.K.Rolling'], '234'], '6754356789876': ['Jane Eyre', 'Romance', ['Charlotte Bronte', 'Emily Bronte'], '345']}
empréstimos = {('65574833907', '1234567890567', '13/07/2020'): ['27/07/2020', 2.0], ('44935673842', '6754356789876', '20/07/2020'): ['05/08/2020', 3.0] }
opção = 0
while opção != "5":
    print("\n---------------------------\n"
              "      Menu de opções:\n"
